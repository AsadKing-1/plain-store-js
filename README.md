...
plain-store — простой и предсказуемый глобальный store состояния
...
plain-store предназначен для управления состоянием в небольших проектах,
...
Примечание: команда будет работать после публикации пакета в npm.
